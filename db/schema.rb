...
ActiveRecord::Schema.define(version: 2018_03_22_154237) do
  ...
  create_table "cards_labels", id: false, force: :cascade do |t|
    ...
    t.index ["label_id", "card_id"], name: "index_cards_labels_on_label_id_and_card_id"
  end
  ...
  create_table "fields", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["object_type", "object_id"], name: "index_fields_on_object_type_and_object_id"
  end
